...
void ArgStream::append(string const& arg) { args.push_back(arg); }
...
bool ArgStream::hasNext() { return args.size() > 0; }
...
ArgParser& ArgParser::command(string const& name, string const& helptext,
                              void (*callback)(string cmd_name,
...
bool ArgParser::commandFound() { return command_name != ""; }

string ArgParser::commandName() { return command_name; }

ArgParser& ArgParser::commandParser() { return *commands[command_name]; }
